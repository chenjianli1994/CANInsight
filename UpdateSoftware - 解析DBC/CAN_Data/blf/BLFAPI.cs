...
namespace PCAN_Client.CAN_Data.blf
{
    ...
    public struct VBLCANMessage2
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)]
        public Byte[] mData;
        public UInt32 mFrameLength;  // 新增字段
        public Byte mBitCount;       // 新增字段
        public Byte mReserved1;
        public UInt16 mReserved2;
    }
    ...
    {
        public VBLObjectHeader mHeader;
        public UInt32 mSource;
        public UInt32 mReserved;
        public UInt32 mTextLength;
        // 注意：mText是变长字段，不包含在结构体大小中
    }
